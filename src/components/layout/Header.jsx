...
export default function Header({ current, PAGE_TITLES }) {
    ...
    return (
        <header className="h-16 px-6 flex items-center justify-between flex-shrink-0 relative bg-white">
            ...
            <div className="flex items-center gap-2.5">
                <span className="text-xs font-medium text-slate-300 tracking-widest uppercase select-none">
                    App
                </span>
            ...
            <div className="flex items-center gap-3">
                ...
                <span
                    className="text-xs font-semibold text-slate-500 tabular-nums tracking-widest"
